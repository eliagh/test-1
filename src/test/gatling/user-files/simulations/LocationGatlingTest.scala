...
class LocationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Location entity")
        ...
        .repeat(2) {
            ...
            .post("/api/locations")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "address1":"SAMPLE_TEXT", "address2":"SAMPLE_TEXT", "address3":"SAMPLE_TEXT", "number":"0", "postcode":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "stateProvince":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
