...
class ActivityGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Activity entity")
        ...
        .repeat(2) {
            ...
            .post("/api/activities")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "logo":null, "description":null, "price":null, "durationMinutes":"0", "preDurationMinutes":"0", "postDurationMinutes":"0", "isPrivate":null, "colorCode":"SAMPLE_TEXT", "cancellationPolicy":null}""")).asJSON
            .check(status.is(201))
