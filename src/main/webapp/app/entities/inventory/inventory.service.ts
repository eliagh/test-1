...
export class InventoryService {
    ...
    private resourceUrl = 'api/inventories';
    private resourceSearchUrl = 'api/_search/inventories';
    ...
    private convertItemFromServer(entity: any) {
        entity.inventoryDate = this.dateUtils
            .convertDateTimeFromServer(entity.inventoryDate);
    }

    private convert(inventory: Inventory): Inventory {
        const copy: Inventory = Object.assign({}, inventory);

        copy.inventoryDate = this.dateUtils.toDate(inventory.inventoryDate);
        return copy;
    }
}
